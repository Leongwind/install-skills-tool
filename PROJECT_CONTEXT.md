...
- Default branch: `main`
- macOS version: `0.2.1`
- Windows version: `0.1.0` in development
- Latest completed Windows milestone: `f5996ba`, initial `windows/` directory
...
Build the independent Windows Tauri application, complete Windows CI, and prepare the
NSIS installer for manual Windows 11 x64 validation with Cursor and Kiro.
